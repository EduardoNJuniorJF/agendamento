...
export default function UserManagement() {
  ...
  const getRoleDescription = (role: string) => {
    switch (role) {
      case "admin":
        return "Controle total e irrestrito ao sistema";
      case "dev":
        return "Controle total e irrestrito ao sistema";
      case "user":
        return "Pode alterar Calendário e Dashboard";
      case "financeiro":
        return "Apenas visualização e impressão";
      default:
        return "";
    }
  };
      ...
      <div className="grid gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Apenas administradores podem criar novos usuários no sistema</CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  <div className="flex items-center space-x-3 p-3 border rounded-lg bg-muted/30">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Marque se o usuário realizará atendimentos externos e aparecerá na lista de agentes
                      </p>
                    </div>
                    {formData.isAgent && (
                      <div className="flex items-center gap-2">
                        <Label htmlFor="agentColor" className="text-xs">
                          Cor:
                        </Label>
                        <Input
                          id="agentColor"
                              ...
                              <AlertDialog>
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      Tem certeza que deseja excluir o usuário <strong>{user.username}</strong>? Esta
